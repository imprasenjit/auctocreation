...
document.addEventListener("DOMContentLoaded", function () {
  // Check if theme object is available
  if (typeof modern_theme_object === "undefined") {
    console.warn("modern_theme_object not defined, using fallback paths");
    window.modern_theme_object = {
      theme_url: "/wp-content/themes/AuctoModern",
      images_url: "/wp-content/themes/AuctoModern/assets/images/backgrounds/",
    };
  }

<?php
// function custom_theme_switcher() {
//     // Check the URL or domain
//     if (strpos($_SERVER['HTTP_HOST'], 'http://localhost/auctocreation/') !== false) {
//         switch_theme('Auctocreation');
//     }
//     // Or check URL path
//     elseif (strpos($_SERVER['REQUEST_URI'], 'http://localhost/auctocreation/event') !== false) {
//         switch_theme('your-special-theme');
//     }
// }
